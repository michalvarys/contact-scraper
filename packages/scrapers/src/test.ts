...
import AiGoogleMapsScraper from './AiGoogleMapScraper';

async function main() {
  const scraper = new AiGoogleMapsScraper();
  // await scraper.scrapeCompanies('Stavební firma', 'Karlovy vary');
  await scraper.getCompanyDataFromLink(
    'https://www.google.com/maps/place/BAU+-+STAV+a.s./data=!4m7!3m6!1s0x47a099f3134a6181:0xbbe646a71f2b1b06!8m2!3d50.2259536!4d12.8159987!16s%2Fg%2F1tdvj56d!19sChIJgWFKE_OZoEcRBhsrH6dG5rs?authuser=0&hl=cs&rclk=1',
  );
  await scraper.close();
