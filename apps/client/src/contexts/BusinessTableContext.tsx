...
export const BusinessTableProvider: React.FC<{
    ...
    const onPageChange = useCallback((page: number) => {
        ...
        // Aktualizace stavu - toto se provede automaticky v efektu při změně filtrů
        // setCurrentPageIndex(page);
        // setAllCompanies([]);
        // isFilterChanged.current = true;

        // Není potřeba volat refetch, protože změna filtrů automaticky vyvolá nové načtení dat
        // refetch();
    }, [filters, setFilters]);
    ...
    const onPageSizeChange = useCallback((newPageSize: number) => {
        ...
        // Není potřeba manuálně resetovat stav, protože to se provede automaticky v efektu při změně filtrů
        // setCurrentPageIndex(1);
        // setAllCompanies([]);
        // isFilterChanged.current = true;
    }, [filters, setFilters]);
