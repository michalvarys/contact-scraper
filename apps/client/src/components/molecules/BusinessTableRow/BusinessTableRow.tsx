...
export const BusinessTableRow: React.FC<BusinessTableRowProps> = ({
    ...
    return (
        ...
        >
            ...
            {/* Odvětví */}
            <TableCell maxWidth={150} withTooltip tooltipText={business.industry?.name || ''}>
                {truncateText(business.industry?.name || '', 20)}
            </TableCell>

            {/* Region */}
            <TableCell maxWidth={150} withTooltip tooltipText={business.region?.name || ''}>
                {truncateText(business.region?.name || '', 20)}
            </TableCell>
